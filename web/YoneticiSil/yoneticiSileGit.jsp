<%-- 
    ...
    Created on : 18.Oca.2021, 16:03:41
    Author     : Elif
--%>
                ...
                <div class="card z-depth-3">
                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td><a href="yoneticiSil.jsp?aid=<%=resultSet.getString("aid")%>"><button style="background-color: red" type="button" class="delete">Sil</button></a></td>
                        </tr>
                        <%
                                    i++;
                                }
